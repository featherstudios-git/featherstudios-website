...
export default function HeroBg3D() {
  ...
  useEffect(() => {
    ...
    const fillLight = new THREE.DirectionalLight(0x0047AB, 2);
    ...
    const glassMaterial = isMobile
      ? new THREE.MeshStandardMaterial({
          ...
          roughness: 0.15,
          metalness: 0.9,
          emissive: new THREE.Color('#0047AB'),
  ...
  return (
    <div
      ...
      style={{
        ...
        inset: 0,
        zIndex: 0,
        filter: isMobile ? 'none' : 'blur(0.5px) drop-shadow(0 0 30px rgba(0,71,171,0.2))',
