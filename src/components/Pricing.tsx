                ...
                {plan.features.map((f, fi) => (
                  <div key={fi} style={{
                    ...
                    <span style={{
                      ...
                      background: f.active ? (plan.featured ? '#0C0C0C' : 'rgba(188,255,79,0.15)') : 'transparent',
                      border: `1px solid ${f.active ? (plan.featured ? '#0C0C0C' : 'rgba(188,255,79,0.4)') : 'currentColor'}`,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                    }}>
                      {f.active
                        ? <Check size={10} color={plan.featured ? '#F2F0EB' : '#BCFF4F'} />
