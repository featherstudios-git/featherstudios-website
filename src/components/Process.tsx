...
const testimonials = [
  { quote: 'Feather Studios completely transformed our online presence. Sales up 40% since launch.', name: 'Marcus K.', role: 'CEO, Apex Solutions', init: 'MK', accent: '#C91B00' },
          ...
          <div>
            <div style={{ display: 'flex', gap: 3 }}>
              {Array.from({ length: 5 }).map((_, i) => (
                <Star key={i} size={16} fill="#C91B00" color="#C91B00" />
              ))}
            </div>
