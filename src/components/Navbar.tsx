    ...
    <>
      ...
      <motion.div
        style={{
          ...
          background: 'var(--lime)', zIndex: 10001,
      ...
      <motion.nav
        ...
        style={{
          ...
          background: scrolled ? 'rgba(22,22,24,0.6)' : 'transparent',
          backdropFilter: scrolled ? 'blur(20px)' : 'none',
          WebkitBackdropFilter: scrolled ? 'blur(20px)' : 'none',
          borderRadius: scrolled ? 100 : 0,
          border: scrolled ? '1px solid rgba(244,244,245,0.08)' : '1px solid transparent',
          boxShadow: scrolled ? '0 10px 40px rgba(0,0,0,0.5), inset 0 1px 0 rgba(244,244,245,0.05)' : 'none',
        }}
      >
        <div style={{
